    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>statusreserva</h2>
                    <a href="create.php" class="btn btn-success mb-3">Novo status da Reserva</a>
                        ...
                        <tbody>
                            <?php foreach ($dao->read() as $statusreserva) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?id=<?= $statusreserva->getIdstatusreserva() ?>" title="Editar" class="btn btn-sm btn-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="destroy.php?id=<?= $statusreserva->getIdstatusreserva() ?>" title="Excluir" class="btn btn-sm btn-danger">
