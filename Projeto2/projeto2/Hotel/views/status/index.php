    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="my-4">
                    <h2>Status</h2>
                    <a href="create.php" class="btn btn-success mb-3">Novo Status</a>
                        ...
                        <tbody>
                            <?php foreach ($dao->read() as $status) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?id=<?= $status->getIdStatus() ?>" title="Editar" class="btn btn-sm btn-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <a href="destroy.php?id=<?= $status->getIdStatus() ?>" title="Excluir" class="btn btn-sm btn-danger">
